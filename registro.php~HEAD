           ...
           <div class="container mb-5">
                ...
                <div class="card-deck text-center mt-5">
                  <div class="card classcard">        
                    <div class="card-body">
                      <h5 class="card-title pasesclass">TICKET POR UN DÍA (Viernes)</h5>
                  ...
                  <div class="card classcard">        
                    <div class="card-body">
                        <h5 class="card-title pasesclass">TICKET POR DOS DÍAS (Viernes y sábado)</h5>
